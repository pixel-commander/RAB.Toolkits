...
This source is at rab-world/paths/beacons. rab-world does not yet have the
toolkit registration and tools/ layout required for Box catalog discovery.
The scaffold follows the existing run({options, context, tool, helpers})
contract but is not yet selectable in the Box tool picker.
